...
Compiling with the Particle cloud is happening with every commit. You can find it in the "Actions" menu (top)
The compiled binary file can be downloaded and flashed via Particle web-IDE, CLI or Particle Dev.
