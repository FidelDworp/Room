...
// 1) Set "Nightlevel" global to a suitable value for this room. (eg: below 150 LUX it is night)
// 2) All customization variables for OPTIONAL devices are filled-out below.
//   ex:
//    - Temperature sensor ID
//    - Smoke sensor deactivated if not installed
//    -
//
// --------------------------------------
// Functions:
...
// START Specific ROOM settings: "Room-......."////////////////////////////////////////////////////////////

// *A1: OPTIONAL connector: NONE, DOTSTAR (Data), KB2 (Touch2), ...
  char OP1_A1[8] = "NONE"; //

// *A2: ROOMSENSE connector: NONE, GAS, DUST
  char GAS_A2[8] = "NONE"; //

// *A4: OPTIONAL connector: NONE, CO2, ...
  char OP2_A4[8] = "NONE"; //

// *A5: OPTIONAL connector: NONE, DOTSTAR (Clock), RESET (LCD), ...
  char OP3_A5[8] = "NONE"; //

// *A6: OPTIONAL connector: NONE, TSTAT, ...
  char OP4_A6[8] = "NONE"; //

// *A7: OPTIONAL connector: NONE, TSTAT, ...
  char OP5_A7[8] = "NONE"; //

// *D3: Select below DS18B20 temperature sensors by uncommenting ONE line:
...
// *D7: ROOMSENSE connector: NONE, GAS, DUST
  char GAS_D7[6] = "NONE"; //

// END Specific ROOM settings: ///////////////////////////////////////////////////////////////////////////
...
// GENERAL settings:
  ...
  //#include "Particle.h" // Needed? => Creates compile errors!
...
// *A7 - OP2 => LASER light sensor (LDR) = "LaserLDRpin" (for CABinet lights)
  ...
  #define OLED_RESET D4// => Originally = D4
          // => D4 = Reset??? Test if not interfering w pixel-line! (I2C displays have no connection to D4???)
...
// Functions per key: Examples with Pixels and text on OLED display...
void FunctionKey1()
{
  strip.setPixelColor(0, strip.Color(255,0,0)); strip.show(); //
  Particle.publish("action","Key-1",60,PRIVATE); delay(500);
  // Show action for this key
    display.clearDisplay();
    display.setTextSize(2);
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-1");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("First pixel ON. Test if I can use a long text which should wrap around...");
    display.display();
    delay(2000);
}
...
void FunctionKey2()
{
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-2");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Second pixel ON. This is an extra explanation of the function selected again to test the wrapping...");
    display.display();
    delay(2000);
}
...
void FunctionKey3()
{
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-3");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Third pixel ON. Test if I can use a long text which should wrap around...");
    display.display();
    delay(2000);
}
...
void FunctionKey4()
{
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-4");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Fourth pixel ON. Test if I can use a long text which should wrap around...");
    display.display();
    delay(2000);
}
...
void FunctionKey5()
{
  strip.setPixelColor(4, strip.Color(255,0,0)); strip.show(); //
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-5");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Fifth pixel ON. Test if I can use a long text which should wrap around...");
    display.display();
    delay(2000);
}
...
void FunctionKey6()
{
  strip.setPixelColor(5, strip.Color(255,0,0)); strip.show(); //
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-6");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Sixth pixel ON. Test if I can use a long text which should wrap around...");
    display.display();
    delay(2000);
}
...
void FunctionKey7()
{
  strip.setPixelColor(6, strip.Color(255,0,0)); strip.show(); //
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-7");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Sevent pixel ON. Test if I can use a long text which should wrap around...");
    display.display();
    delay(2000);
}
...
void FunctionKey8()
{
  strip.setPixelColor(7, strip.Color(255,0,0)); strip.show(); //
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-8");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Eight pixel ON. Test if I can use a long text which should wrap around...");
    display.display();
    delay(2000);
}
...
void FunctionKey9()
{
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-9");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Turn First pixel OFF again. I will use this keyboard to display incoming Particle messages...");
    display.display();
    delay(2000);
}
...
void FunctionKey10()
{
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-10");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Turn Second pixel OFF again. I will use this keyboard to display incoming Particle messages...");
    display.display();
    delay(2000);
}
...
void FunctionKey11()
{
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-11");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Turn Third pixel OFF again. I will use this keyboard to display incoming Particle messages...");
    display.display();
    delay(2000);
}
...
void FunctionKey12()
{
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-12");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Turn Fourth pixel OFF again. I will use this keyboard to display incoming Particle messages...");
    display.display();
    delay(2000);
}
...
void FunctionKey13()
{
  strip.setPixelColor(4, strip.Color(0,0,0)); strip.show(); //
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-13");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Turn Fifth pixel OFF again. I will use this keyboard to display incoming Particle messages...");
    display.display();
    delay(2000);
}
...
void FunctionKey14()
{
  strip.setPixelColor(5, strip.Color(0,0,0)); strip.show(); //
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-14");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Turn Sixth pixel OFF again. I will use this keyboard to display incoming Particle messages...");
    display.display();
    delay(2000);
}
...
void FunctionKey15()
{
  strip.setPixelColor(6, strip.Color(0,0,0)); strip.show(); //
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-15");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Turn Seventh pixel OFF again. I will use this keyboard to display incoming Particle messages...");
    display.display();
    delay(2000);
}
...
void FunctionKey16()
{
  strip.setPixelColor(7, strip.Color(0,0,0)); strip.show(); //
  ...
  // Show action for this key
    ...
    display.setTextColor(WHITE);
    display.setCursor(0,0);
    display.println("Key-16");
    display.setTextSize(1);
    display.setCursor(0,20);
    display.println("Turn Eight pixel OFF again. I will use this keyboard to display incoming Particle messages...");
    display.display();
    delay(2000);
}
