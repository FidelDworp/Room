...
// START Specific ROOM settings: "Room-INKOM"////////////////////////////////////////////////////////////
...
char GAS_A2D7[10] = "NONE"; //

// *A4: OPTIONAL connector: NONE, CO2_PWM, ...
char OP2_A4[10] = "NONE"; //

// *A5: OPTIONAL connector: NONE, PIR2, DOTSTAR_C, RESET (LCD), ...
char OP3_A5[10] = "PIR2"; //
...
void loop()
{
  ...
  if (strcmp(OP2_A4, "CO2_PWM") == 0)
  {
    ...
    if ((millis()-getCO2LastTime) > getCO2Interval)
    {
      ...
      /* BandB room: Tijdelijk uitschakeled = 4 "CO indicator LEDs" in badkamer! Later opnieuw inschakelen...
      for(int i=0;i<4;i++)
      {
...
if (strcmp(OP5_A7, "LASERRCV") == 0)
{
  ...
  // ATTENTION: May be temporarily switched off when laser beam is not correctly set...
...
void FunctionKey7()
{
  ...
  display.setTextSize(1);
  display.setCursor(0,20);
  display.println("Seventh pixel ON. Test if I can use a long text which should wrap around...");
  display.display();
  delay(2000);
}
